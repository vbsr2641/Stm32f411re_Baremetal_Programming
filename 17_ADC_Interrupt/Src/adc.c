...
/*RM: Mask value for End of conversion interuupt enable and need to assign to ADC1_CR1*/
...
void pa1_adc_interrupt_init(void)
{
    ...
    /*RM: Enable the ADC End of conversion interrupt*/
    ADC1->CR1 |= CR1_EOCIE;

    /*BSP: Enable ADC interrupt in NVIC*/
