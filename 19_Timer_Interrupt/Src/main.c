...
/* RM: Function prototype for tim2_callback */
...
int main(void)
{
	...
	/* Initialize the Timer 2 Module in interrupt mode */
...
{
	/*RM:Clear update interrupt flag*/
	TIM2->SR &=~ SR_UIF;

	/*Do something: Invoke Timer 2 callback*/
	tim2_callback();
}
